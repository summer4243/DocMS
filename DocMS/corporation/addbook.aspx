<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addbook.aspx.cs" Inherits="DocMS.corporation.addbook" %>
...
<body>
    <form id="Form1" runat="server">
        <div class="container">
            ...
            <div id="div_main" class="row" runat="server" style="margin: 0 auto; margin-top: 10px; margin-bottom:20px">
            ...
            <div class="row" id="footer">
                企业后台管理系统 &nbsp;&nbsp;&nbsp;&nbsp;<a href="corporation_index.aspx" target="_blank">查看主页</a>
            </div>
        </div>
