<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="corporation_register.aspx.cs" Inherits="DocMS.corporation.corporation_register" %>
	...
	<div id="main" class="row">
		...
		<div id="regbox" class="col-xs-6">
			<div class="form-inline">
				<asp:TextBox ID="txt_name" runat="server" class="form-control" placeholder="企业名（不超过15字）"
				oninput="$('#lab_tip_name').html('');" ></asp:TextBox>
				<asp:Label ID="lab_tip_name" runat="server" ForeColor="Red"></asp:Label>
				<asp:RequiredFieldValidator ID="RequiredFieldValidator_name" runat="server" ErrorMessage="请输入企业用户名"
			...
			<asp:Button ID="btn_reg" runat="server" Text="注册新企业用户" class="btn btn-info" onclick="btn_reg_Click" />
			<div id="link">
