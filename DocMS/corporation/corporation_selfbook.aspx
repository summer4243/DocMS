<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="corporation_selfbook.aspx.cs" Inherits="DocMS.corporation.corporation_selfbook" %>
            ...
            <div id="header">
                <nav class="navbar navbar-default" role="navigation">
                    <div class="collapse navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right" runat="server" id="div_navlik" style="margin-top: 10px; margin-right: 100px;">
                            <li style="margin-left: 20px;">
                                <asp:Button ID="btn_buymenu" runat="server" Text=" 购买目录 " class="btn btn-default" OnClick="btn_buymenu_Click" Style="width: 100px;" />
                            </li>
                            <li style="margin-left: 20px;">
                                <asp:Button ID="btn_manage" runat="server" Text="企业管理" class="btn btn-info" OnClick="btn_manage_Click" Style="width: 100px;" />
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <div id="div_main" runat="server" style="margin: 0 auto; margin-top: 0px; margin-bottom: 0px; margin-left: 10px;">
                    <div id="topnav" class="topmenu">
                        <ul class="nav nav-tabs">
                            <li><a href="corporation_index.aspx">企业购买书籍</a></li>
                            <li class="active"><a>企业自身书籍</a></li>
                            <li><a href="corporation_adminbook.aspx">总部系统书籍</a></li>
                        </ul>
                    </div>
                </div>
            </div>
