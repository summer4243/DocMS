<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_list.aspx.cs" Inherits="DocMS.corporation.user_list" %>
            ...
            <div id="div_main" class="row" runat="server" style="margin: 0 auto; margin-top: 10px;">
                <div id="leftnav" class="col-xs-2">
                    <ul class="nav nav-list">
                        <li><a href="user_list.aspx">企业成员列表</a></li>
                        <li><a href="user_alterpassword.aspx">成员密码修改</a></li>
                    </ul>
                </div>
                <div id="userlist" class="col-xs-6">
                    <h3>成员列表</h3>
                    <br />
                    <table class="table table-bordered table-hover">
                        ...
                        <asp:Repeater ID="rep_userlist" runat="server" OnItemCommand="rep_userlist_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    <td><%#Eval("name")%></td>
                                    <td><%#Eval("password") %></td>
