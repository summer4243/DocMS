<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="result_corporation.aspx.cs" Inherits="DocMS.corporation.result_corporation" %>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-left" runat="server" style="margin-top: 10px; margin-left: 20px; width:100px;">
                            <li>
