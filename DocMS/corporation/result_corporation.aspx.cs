        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!IsPostBack)
            {
                ...
                sql = "SELECT dbo.CorpoBook.abook_id AS id,dbo.CorpoBook.corporation_id,dbo.CorpoBook.name,dbo.CorpoBook.url,dbo.CorpoBook.star,"+
                       ...
                       " WHERE dbo.CorpoBook.name LIKE '%" + search + "%' OR dbo.CorpoBook.keyword LIKE '%" + search + "%' OR dbo.CorpoBooktype.name LIKE '%" + search + "%' OR dbo.CorpoBook.author LIKE '%" + search + "%'AND dbo.CorpoBook.corporation_id=" + corporation.id;
