        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!IsPostBack)
            {
                ...
                sql = "SELECT dbo.CorSelfBook.id,dbo.CorSelfBook.corporation_id,dbo.CorSelfBook.name,dbo.CorSelfBook.url,dbo.CorSelfBook.star," +
                       ...
                       " WHERE dbo.CorSelfBook.name LIKE '%" + search + "%' OR dbo.CorSelfBook.keyword LIKE '%" + search + "%' OR dbo.CorSelfBooktype.name LIKE '%" + search + "%' OR dbo.CorSelfBook.author LIKE '%" + search + "%' AND dbo.CorSelfBook.corporation_id="+corporation.id;
