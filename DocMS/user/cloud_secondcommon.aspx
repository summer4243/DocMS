<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cloud_secondcommon.aspx.cs" Inherits="DocMS.user.cloud_secondcommon" %>
            ...
            <div id="div_main" class="row" runat="server" style="margin: 0 auto; margin-top: 10px;">
                <div id="leftnav" class="col-xs-2" runat="server">
                    <ul class="nav nav-list">
                        <li><a href="cloud_secondboss.aspx">组长推荐</a></li>
                        <li><a href="cloud_secondcommon.aspx">组员推荐</a></li>
                    </ul>
                </div>

                <div id="boss_recommend" runat="server" class="col-xs-7">
                    <p style="text-align:left;font-size:18px;" class="text-danger">组员推荐</p>
