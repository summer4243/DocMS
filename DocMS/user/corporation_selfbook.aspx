<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="corporation_selfbook.aspx.cs" Inherits="DocMS.user.corporation_selfbook" %>
                ...
                <div id="div_main" runat="server" style="margin: 0 auto; margin-top: 0px; margin-bottom: 0px; margin-left: 10px;">
                    <div id="topnav" class="topmenu">
                        <ul class="nav nav-tabs">
                            <li><a href="user_index.aspx">企业购买书籍</a></li>
