<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cloud_thirdcommon.aspx.cs" Inherits="DocMS.user.cloud_thirdcommon" %>
            ...
            <div id="div_main" class="row" runat="server" style="margin: 0 auto; margin-top: 10px;">
                <div id="leftnav" class="col-xs-2" runat="server">
                    <ul class="nav nav-list">
                        <li><a href="cloud_thirdboss.aspx">组长推荐</a></li>
                        <li><a href="cloud_thirdcommon.aspx">组员推荐</a></li>
                    </ul>
                </div>
