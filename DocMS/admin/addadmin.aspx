<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addadmin.aspx.cs" Inherits="DocMS.admin.addadmin" %>
    ...
    <form id="Form1" runat="server">
        <div class="container">
            ...
            <div id="div_main" class="row" runat="server" style="margin: 0 auto; margin-top: 10px;">
                ...
                <div id="addadmin" class="col-xs-3">
                    <h3>添加管理员</h3>
                    <br />
                    <asp:TextBox ID="txt_name" runat="server" class="form-control" placeholder="新账户名"></asp:TextBox>
                    <br />
                    <asp:TextBox ID="txt_psw" runat="server" class="form-control" placeholder="账户密码"></asp:TextBox>
                    <br />
